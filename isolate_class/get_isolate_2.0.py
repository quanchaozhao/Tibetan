...
def isolate_character(image,file,file2):
    ...
    #         if  (max_col - min_col) / (max_row - min_row) >= 1.7 :
    #             io.imsave("D:\\datebase\\标注数据\\isolate_character_three_touch\\" + file.split(".")[0] + str(i) + ".png",totallist[i][1] * 255, cmap="gray")
    #             print("D:\\datebase\\isolate_character_two_touch\\" + file.split(".")[0] + str(i) + ".png")
    #         else:
    #            io.imsave("D:\\datebase\\标注数据\\isolate_character_two_touch\\" + file.split(".")[0] + str(i) + ".png", totallist[i][1] * 255, cmap="gray")
    #            print("D:\\datebase\\isolate_character_two_touch\\" + file.split(".")[0] + str(i) + ".png")
    DPI = 100
    rows, cols = image.shape
    figsize = cols / DPI, rows / DPI
