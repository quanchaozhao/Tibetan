...
baselinefile = r'C:\Users\Zqc\Desktop\mark\第二次数据-寒假\total-three\base_line_three.txt'
file = open(baselinefile, 'r')
line = file.readline()[:-1]
Path = r"C:\Users\Zqc\Desktop\mark\第二次数据-寒假\total-three\total-alter-xml"
AlterPath = r'C:\Users\Zqc\Desktop\mark\第二次数据-寒假\total-three\total-addbaseline'
while (line != None):
